    ...
    <PageTransition>
      <section className="bg-surface-dark pt-32 pb-20">
        <div className="max-w-6xl mx-auto px-6">
          <p className="hero-reveal hero-delay-1 text-navy-light font-medium text-sm uppercase tracking-widest mb-4">Background</p>
          <h1 className="hero-reveal hero-delay-2 text-5xl md:text-7xl font-bold tracking-tight gradient-text">About Me</h1>
          <p className="hero-reveal hero-delay-3 mt-4 text-text-secondary text-lg max-w-2xl">Investment professional, entrepreneur, and strategic thinker based in Chicago.</p>
        </div>
      </section>
            ...
            <div className="space-y-8">
              <div className="flex flex-col sm:flex-row sm:items-start gap-4">
                <div className="sm:w-48 shrink-0">
                  <span className="text-sm text-text-secondary">2025 – 2027</span>
                </div>
                <div>
              ...
              <div className="flex flex-col sm:flex-row sm:items-start gap-4">
                <div className="sm:w-48 shrink-0">
                  <span className="text-sm text-text-secondary">2016 – 2020</span>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">
        ...
        <ScrollReveal>
          <section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="p-6 rounded-2xl border border-gray-100 bg-white hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
